...
import {FlatList, SafeAreaView, Text, View,TouchableOpacity,Pressable,Image} from 'react-native';
...
const Tasks = () => {
  ...
  const renderTask = ({item}) => {
    ...
    const deadlineFormatted = moment(deadline).format('YYYY-MM-DD').split("-").reverse().join("-");
    ...
    return (
      ...
      <View style={styles.row}> 
        ...
        <Text style={[styles.taskText, item?.checked ? styles.checked : {}]}>
          ...
          <Pressable style={styles.deletecontainer}  onPress={() => onTaskDelete(item)}>
